...
export async function POST(request: NextRequest) {
  ...
  if (!PCO_CLIENT_ID || !PCO_CLIENT_SECRET || !TOKEN_SECRET || !PCO_REDIRECT_URI) {
  ...
  try {
    ...
    if (userData.data.attributes.organization_name !== 'Covenant Community Church') {
    ...
    // 5. Set the JWT as a secure, httpOnly cookie
