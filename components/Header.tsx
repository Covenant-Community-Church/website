                    ...
                    <div className="md:hidden">
                        <div className="px-2 pt-2 pb-3 space-y-1 bg-white rounded-lg mt-2 shadow-lg border border-warm">
                            ...
                            <div className="border-b border-warm pb-2 mb-2">
                                <div className="px-3 py-2 text-sm font-medium text-navy font-body">About Us</div>
                                <a href="/meeting-times"
                                   className="block px-6 py-2 text-sm text-brown hover:bg-warm font-body"
                            ...
                            <a href="/care-groups"
                               className="block px-3 py-2 text-sm text-brown hover:bg-warm font-body rounded-lg"
                               onClick={() => setIsMobileMenuOpen(false)}>
                                Care Groups
                            </a>
                            ...
                            <a href="https://covenantcc.churchcenter.com/giving"
                               className="block bg-navy hover:bg-navy/90 text-white px-3 py-2 rounded-2xl text-sm font-medium font-body mx-3 mt-3 text-center"
                               onClick={() => setIsMobileMenuOpen(false)}>
                                Give
                            </a>
                        </div>
