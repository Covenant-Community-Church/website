...
const contactInfo = [
  { 
    icon: MapPin, 
    text: "5104 E Stevenson Ave, Chillicothe, IL 61523",
    href: "https://maps.app.goo.gl/rcJqyYRjEYSA2ZsB9"
  },
  { 
    icon: Phone, 
    text: "(309) 274-3884",
    href: "tel:+13092743884"
  },
  { 
    icon: Mail, 
    text: "office@covenantcommunity.org",
        ...
        <div className="py-12">
          <div className="mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 md:text-right">
              ...
              >
                © {new Date().getFullYear()} Covenant Community Church <br />
                All rights reserved.
              </motion.div>
            </div>
          </div>
